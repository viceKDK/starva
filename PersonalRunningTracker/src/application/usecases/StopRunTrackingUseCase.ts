import { IGPSService, IRunRepository, DatabaseError } from '@/domain/repositories';
...
export class StopRunTrackingUseCase {
  constructor(
    private gpsService: IGPSService,
    private runRepository: IRunRepository
  ) {}

  async execute(): Promise<Result<StopTrackingResult, GPSError | DatabaseError>> {
